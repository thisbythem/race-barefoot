<form class="add-review-form">
  <div class="sub-section">
    <fieldset class="rating-stars-input">
  ...
  <div class="sub-section">
    <fieldset class="race-comments">
      <h5>Write your review</h5>
      <textarea rows="15" placeholder="Give us the details!"></textarea>
    </fieldset>
    <fieldset class="form-actions"><input type="submit" value="Add Review"></fieldset>
  </div>
