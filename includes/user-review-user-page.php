<div class="user-review user-page-review">
    <div class="sub-section user-review-ratings">
      <div class="user-rating-category-wrap">
        ...
        <div class="rating-stars">
          ...
          <span class="rating-star star-on"><i class="fa fa-star"></i></span>
          <span class="rating-star star-on"><i class="fa fa-star"></i></span>
          <span class="rating-star star-on"><i class="fa fa-star-half-o "></i></span>
          <span class="rating-star"><i class="fa fa-star-o"></i></span>
        </div>
      </div>
      <div class="user-rating-category-wrap">
        <h5>Barefoot-Friendly Terrain</h5>
        <div class="rating-stars">
          <span class="rating-star star-on"><i class="fa fa-star"></i></span>
          <span class="rating-star star-on"><i class="fa fa-star"></i></span>
          <span class="rating-star star-on"><i class="fa fa-star-half-o"></i></span>
    ...
    <div class="sub-section user-review-content">
      ...
      <div class="user-review-stats">
        <div class="user-review-stat"><h5>Raced</h5> <p>March, 2016</p></div>
        <div class="user-review-stat"><h5>Distance</h5> <p>5k</p></div>
        <div class="user-review-stat"><h5>Reviewed</h5> <p>April 22, 2016</p></div>
        <div class="user-review-stat"><h5>Style</h5> <p>Entirely Barefoot</p></div>
      </div>
    </div>
</div>
